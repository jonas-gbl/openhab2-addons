...
public class ClimateSensorHandler extends VerisureThingHandler implements InstallationOverviewReceivedListener {
    ...
    public void updateClimateSensorState(ClimateValue climateValue) {
        ...
        OffsetDateTime climateValueTime = climateValue.getTime();
        if (climateValueTime != null) {

            Calendar calendar = Calendar.getInstance();
            calendar.setTime(Date.from(climateValueTime.toInstant()));
        ...
        String sensorArea = climateValue.getDeviceArea();
        if (sensorArea != null) {
            String sensorLocation = sensorArea + " (" + climateValue.getDeviceType() + ")";
